...
def main():
    ...
    scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=args.pretrain_epochs, eta_min=0)
    ...
    optimizer = optim.SGD(model.parameters(), lr=args.lr * 0.01, momentum=0.9, weight_decay=5e-4)
