...
python main_attack.py --dataset cifar100 --model MobileNetV2 --unlearned_algo neggrad  --aux_size 100 --total_loops 100 --unlr 0.01 --alpha 1 --batch_size 64 --mini_batch_size 64 --local_loops 1 --seed 0
